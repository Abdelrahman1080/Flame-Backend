...
public class JwtAuthrnticationFilter extends OncePerRequestFilter {
    private static final Logger log = LoggerFactory.getLogger(JwtAuthrnticationFilter.class);
    ...
    protected void doFilterInternal(
        ...
        if(authHeader ==null || !authHeader.startsWith("Bearer ")){
            log.debug("No Authorization header or does not start with Bearer: {}", authHeader);
        ...
        try {
            ...
            // invalid token — continue chain without setting security context
